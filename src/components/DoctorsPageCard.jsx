...
export default function DoctorsPageCard({ photo, name, specialty, location, qualifications, onBookAppointment }) {
  return (
    <div className="doctor-card shadow">
      ...
      <div className="card-footer d-flex justify-content-between">
        ...
        <button
          className='btn mb-2'
          style={{backgroundColor:"#222F66", padding:"8px 15px",borderRadius:"8px",color:"white"}}
