          ...
          <div className="p-4" style={{ backgroundColor: '#222F66', borderRadius: '10px', height: '100%' }}>
            ...
            <form>
              <div className="mb-3">
                ...
                <input type="text" style={{backgroundColor:"#222F66",color:"white"}} className="form-control text-white" id="name" placeholder="Enter your name" />
              </div>
              <div className="mb-3">
                <label htmlFor="email" className="form-label text-light">Email address</label>
                <input type="email" style={{backgroundColor:"#222F66",color:"white"}} className="form-control" id="email" placeholder="name@example.com" />
              </div>
              <div className="mb-3">
                <label htmlFor="phone" className="form-label text-light">Phone Number</label>
                <input type="text" style={{backgroundColor:"#222F66",color:"white"}} className="form-control" id="phone" placeholder="Enter your phone number" />
              </div>
              <div className="mb-3">
                <label htmlFor="date" className="form-label text-light">Appointment Date</label>
                <input type="date" style={{backgroundColor:"#222F66",color:"white"}} className="form-control" id="date" />
              </div>
